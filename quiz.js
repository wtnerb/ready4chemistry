...
(function (){
    ...
    new Question ('How much heat is transferred per mole of NHz3(g) formed in the reaction shown below?\r\n\r\tNz2(g) + 3 Hz2(g) => 2 NHz3(g) \t\t\u0394H\u00B0 = - 92.2 kJ', ['92.2 kJ', '46.1 kJ', '30.7 kJ', '15.4 kJ'], '46.1 kJ', 'Thermochemistry and Stoichiometry');
    new Question ('The action of some commercial drain cleaners is based on the following reaction:\r\n\r\t2NaOH(s) + 2 Al(s) + 6 Hz2O(l) => 2 NaAl(OH)z4(s) + Hz2(g)\r\n\rWhat is the volume of Hz2 gas formed at STP when 4.3 g of Al reacts with excess NaOH?', ['2.4 L', '3.6 L', '5.4 L', '5.9 L'], '5.4 L', 'Gas law stoichiometry');
    new Question ('What volume of 0.72 M KBr solution is needed to provide 10.5 g of KBr?', ['7.5 mL', '15 mL', '63 mL', '120 mL'], '7.5 mL', 'Basic stoichiometry');
